...
class Rock(models.Model):
    """Model clasification for mineral objects"""
    name = models.CharField(max_length=255)
    image_filename = models.FileField(upload_to='static/rocks/images/')
    ...
    refractive_index = models.CharField(max_length=255, default=None)
    group = models.CharField(max_length=255)
    crystal_habit = models.CharField(max_length=255, default=None)
    specific_gravity = models.CharField(max_length=255, default=None)
